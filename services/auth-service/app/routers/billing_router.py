...
def create_checkout_session(current_user=Depends(get_current_user)):
    session = stripe.checkout.Session.create(
        ...
        success_url="http://43.201.103.180/frontend/app.html?billing=success&session_id={CHECKOUT_SESSION_ID}#/settings",
        cancel_url="http://43.201.103.180/frontend/app.html?billing=cancel#/settings",        customer_email=current_user.email,
